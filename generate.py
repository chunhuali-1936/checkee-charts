        ...
        plugins: {{
          ...
          annotation: {{ annotations: {{
            ...
            obama: {{
              ...
              backgroundColor: 'rgba(33,150,243,0.07)', borderWidth: 0,
              label: {{ content: 'Obama', display: true, position: {{ x: 'center', y: 'start' }},
                font: {{ size: 10, style: 'italic' }}, color: 'rgba(33,150,243,0.6)' }},
            }},
            trump1: {{
              type: 'box', xScaleID: 'x',
              ...
              backgroundColor: 'rgba(244,67,54,0.07)', borderWidth: 0,
              label: {{ content: 'Trump I', display: true, position: {{ x: 'center', y: 'start' }},
                font: {{ size: 10, style: 'italic' }}, color: 'rgba(244,67,54,0.6)' }},
            }},
            biden: {{
              type: 'box', xScaleID: 'x',
